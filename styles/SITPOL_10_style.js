var size = 0;
var placement = 'point';
function categories_SITPOL_10(feature, value, size, resolution, labelText,
...
default:
        ...
        image: new ol.style.Circle({radius: 4.0 + size,
            stroke: new ol.style.Stroke({color: 'rgba(35,35,35,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(55,222,197,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_SITPOL_10 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Secteur_1");
    var labelText = "";
    size = 0;
...
var style = categories_SITPOL_10(feature, value, size, resolution, labelText,
